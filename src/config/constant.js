const localApiUrl = 'http://localhost:2800/api';
const globalApiUrl = 'https://server.cirillsokolov.com:2800/api';
const env = process.env.NODE_ENV;
export const GA_ID = 'G-K7FGW03X55';
export const BASE_TITLE = 'SVG to SVGHMI';
export const API_SERVER = env === 'production' ? globalApiUrl : localApiUrl;
