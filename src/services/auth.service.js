...
export const register = async (name, email, password) => await postResource('users/register', { email, password, name });
...
export const changePassword = async (password, token) => await postResource('users/change_credentials/password', { password }, token);

export const changeEmail = async (email, token) => await postResource('users/change_credentials/email', { email }, token);
